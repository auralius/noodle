...
// ------------------------------------------------------------
// Weights
#include "blood/w01.h"   // stem conv3x3 (3->8)
#include "blood/w02.h"   // B1 DW3x3 (8ch)
#include "blood/w03.h"   // B1 PW1x1 (8->8)
#include "blood/w04.h"   // B2 DW3x3 (8ch)
#include "blood/w05.h"   // B2 PW1x1 (8->8)
#include "blood/w06.h"   // B3 DW3x3 s2 (8ch)
#include "blood/w07.h"   // B3 PW1x1 (8->16)
#include "blood/w08.h"   // B4 DW3x3 (16ch)
#include "blood/w09.h"   // B4 PW1x1 (16->16)
#include "blood/w10.h"   // B5 DW3x3 s2 (16ch)
#include "blood/w11.h"   // B5 PW1x1 (16->24)
#include "blood/w12.h"   // B6 DW3x3 (24ch)
#include "blood/w13.h"   // B6 PW1x1 (24->24)
#include "blood/w14.h"   // Dense (24->8)  (exporter should make this [8,24] row-major)

// Biases
#include "blood/b01.h"   // stem conv bias (8)
#include "blood/b02.h"   // Dense bias (8)  (if your exporter names this differently, adjust here)

// BatchNorm packed as: [gamma(C), beta(C), mean(C), var(C)] (use noodle_bn(x,C,W,bnXX,eps))
#include "blood/bn01.h"  // stem_bn (C=8)
#include "blood/bn02.h"  // B1_dw_bn (C=8)
#include "blood/bn03.h"  // B1_pw_bn (C=8)
#include "blood/bn04.h"  // B2_dw_bn (C=8)
#include "blood/bn05.h"  // B2_pw_bn (C=8)
#include "blood/bn06.h"  // B3_dw_bn (C=8)
#include "blood/bn07.h"  // B3_pw_bn (C=16)
#include "blood/bn08.h"  // B4_dw_bn (C=16)
#include "blood/bn09.h"  // B4_pw_bn (C=16)
#include "blood/bn10.h"  // B5_dw_bn (C=16)
#include "blood/bn11.h"  // B5_pw_bn (C=24)
#include "blood/bn12.h"  // B6_dw_bn (C=24)
#include "blood/bn13.h"  // B6_pw_bn (C=24)
...
static const uint16_t MAX_FEAT_FLOATS = (uint16_t)28 * 28 * 8;  // 6272
...
void predict()
{
  ...
  uint16_t pred;
  float max_val;
  noodle_find_max(out, 8, max_val, pred);
