...
// ------------------------------------------------------------
// Weights
#include "w01.h"   // stem conv3x3 (3->8)
...
#include "w14.h"   // Dense (24->8)  (exporter should make this [8,24] row-major)

// Biases
#include "b01.h"   // stem conv bias (8)
#include "b02.h"   // Dense bias (8)  (if your exporter names this differently, adjust here)
