// Auto-generated from imagenet_classes.txt
// ImageNet-1K labels, 0-based indexing.
// Note: line 1 in the text file corresponds to class 0.
#pragma once

#include <Arduino.h>

static const char * const IMAGENET_CLASSES[1000] = {
  "tench", // 0
  "goldfish", // 1
  "great white shark", // 2
  "tiger shark", // 3
...
static inline const char *imagenet_label(uint16_t class_id) {
  return (class_id < 1000) ? IMAGENET_CLASSES[class_id] : "unknown";
}
